...
class GroupPageState extends State<GroupPage>
  ...
  Future<bool> _removeMattressFromGroup(
      String mattressId, String groupId) async {
    List<String> mattressIds = [];
    mattressIds.add(mattressId);

    var groupModel =
        EditMattressesToGroupModel(groupId: groupId, mattressIds: mattressIds);
  ...
  Future<bool> _addMattressesToGroup(
      List<String> mattresses, String groupId) async {
    var mattressToAdd =
    ...
    return Consumer<LanguageProvider>(builder: (context, value, child) {
      return Scaffold(
        body: _loading
            ...
            : _error
                ? const Center(
                    child: Text("Error loading groups. Try again later."))
                : Column(
                    children: [
                      ...
                      Container(
                          ...
                          border: Border(
                            bottom: BorderSide(
                              color: theme.colorScheme
                                  .shadow, // This controls the divider line
                              width: 1.0,
                            ),
                          ),
                        ),
                        ...
                        child: TabBar(
                          ...
                          tabs: [
                            Tab(
                                text: languages[languageProvider
                                    .currentLanguage]!["Group"]!["Active"]!),
                            Tab(
                                text: languages[languageProvider
                                    .currentLanguage]!["Group"]!["Archived"]!),
                          ],
                        ),
                      ),
                      // Tab Views
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GroupCardWidget(
          ...
          onTap: () async {
            final groupDetails =
                await _groupRepository.getGroupById(group.uid!);
