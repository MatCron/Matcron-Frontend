...
import 'Robots/main_navigation_robot.dart'; // Import your dependency initializer
...
void main() async {
  ...
  group('Login Page Tests', () {
    ...
    late MainNavigationRobot mainNavigationRobot;
    ...
    testWidgets('Login with invalid credentials shows error', (tester) async {
      ...
      mainNavigationRobot = MainNavigationRobot(tester);
      ...
      await mainNavigationRobot.pumpUntilFound(
          tester, find.text('Welcome to Matcron!'));
